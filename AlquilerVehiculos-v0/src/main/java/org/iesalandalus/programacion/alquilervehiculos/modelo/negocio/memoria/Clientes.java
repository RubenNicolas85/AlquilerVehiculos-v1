...
import org.iesalandalus.programacion.alquilervehiculos.modelo.dominio.comparadores.compararClientesDni;
import org.iesalandalus.programacion.alquilervehiculos.modelo.dominio.comparadores.compararClientesNombre;
...
public class Clientes implements IClientes{
	...
	public List<Cliente> get(){
		...
		Collections.sort(coleccionClientes, new compararClientesDni());
		Collections.sort(coleccionClientes, new compararClientesNombre());

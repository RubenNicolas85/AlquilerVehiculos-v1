...
import org.iesalandalus.programacion.alquilervehiculos.modelo.dominio.comparadores.compararVehiculosMarca;
import org.iesalandalus.programacion.alquilervehiculos.modelo.dominio.comparadores.compararVehiculosMatricula;
import org.iesalandalus.programacion.alquilervehiculos.modelo.dominio.comparadores.compararVehiculosModelo;
...
public class Vehiculos implements IVehiculos {
	...
	public List<Vehiculo> get() {
		...
		Collections.sort(coleccionVehiculos, new compararVehiculosMatricula());
		Collections.sort(coleccionVehiculos, new compararVehiculosModelo());
		Collections.sort(coleccionVehiculos, new compararVehiculosMarca());

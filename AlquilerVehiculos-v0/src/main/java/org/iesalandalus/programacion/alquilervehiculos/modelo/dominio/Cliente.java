...
public class Cliente {
	...
	/* Se crea el método de clase que se indica en el diagrama, que dado un DNI correcto nos 
	 * devuelva un cliente válido con ese DNI y que será utilizado en las futuras búsquedas */
